...
#[ignore]
fn test_gt() {
    assert!(decimal("50.001") > decimal("50.0009"));
    assert!(decimal("50.0002") > decimal("5.00002"));
    assert!(decimal("50.0002") > decimal("50.0001"));
    assert!(decimal("99.001") > decimal("90.001"));
    assert!(decimal("-50.001") < decimal("-50.0009"));
    assert!(decimal("-50.0002") < decimal("-5.00002"));
    assert!(decimal("-50.0002") < decimal("-50.0001"));
    assert!(decimal("-99.001") < decimal("-90.001"));
...
#[ignore]
fn test_add() {
    assert_eq!(decimal("111111") + decimal("0.2"), decimal("111111.2"));
...
#[ignore]
fn test_mul() {
    assert_eq!(decimal("5") * decimal("8"), decimal("40"));
    assert_eq!(decimal("0.005") * decimal("-8"), decimal("-0.04"));
    assert_eq!(decimal("987099089") * decimal("909789"), decimal("898051893082221"));
    for big in BIGS.iter() {
...
#[ignore]
fn test_add_sub() {
    assert_eq!(decimal("1") + decimal("2"), decimal("3"));
    assert_eq!(decimal("1") + decimal("-2"), decimal("-1"));
    assert_eq!(decimal("-1") + decimal("2"), decimal("1"));
    assert_eq!(decimal("-1") + decimal("-2"), decimal("-3"));
    assert_eq!(decimal("1") - decimal("2"), decimal("-1"));
    assert_eq!(decimal("1") - decimal("-2"), decimal("3"));
    assert_eq!(decimal("-1") - decimal("2"), decimal("-3"));
    assert_eq!(decimal("-1") - decimal("-2"), decimal("1"));
    assert_eq!(decimal("2") - decimal("1"), decimal("1"));
}
